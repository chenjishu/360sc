  ...
  getEleWidth: function (w) {
    ...
    try {
      ...
      var
        ...
        scale = (750 / 2) / (w / 2);//以宽度750px设计稿做宽度的自适应

      //console.log(scale);

      real
        = Math.floor(res / scale);
    ...
    var
      ...
      list = [
...

        {
          ...
          txt: "圣诞节(Christmas或CristoMessa ), 译名为“基督弥撒”。"
